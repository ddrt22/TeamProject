...
public class ShelterInpo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true); //툴바에 뒤로라기 추가.
    ...
    public void mOnClick(View view){
        ...
        switch (view.getId()){
            case R.id.btnEdit://편집 버튼을 누르면
                ...
                EList.putExtraInfo(intent,nameText.getText().toString(),
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode==0&&resultCode==RESULT_OK){
            ...
            EList.putExtraInfo(toMain,data.getStringExtra("name"),
